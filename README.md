...
主要功能
1. 支持图片、视频及摄像头进行检测；
2. 可对检测结果进行单独分析，并且显示单次检测的置信度;
项目地址https://github.com/Xuding0829/Well
环境配置
python
...
数据集预处理
利用labelimg数据标注网站对井盖隐患数据集进行预处理，将图片中的每一类井盖框起来并打上标签。
数据标注
labelimg
...
后续尝试-->加入注意力机制
参考资料https://blog.csdn.net/weixin_43694096/article/details/124443059https://blog.csdn.net/weixin_43694096/article/details/124695537
遇到的一些问题
conda安装包报错
